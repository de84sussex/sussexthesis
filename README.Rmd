...
[thesisdown](https://github.com/ismayc/thesisdown) package. The thesis template is designed to be compatible with the requirements of the University of Sussex, and currently only works when knitting to pdf. 
