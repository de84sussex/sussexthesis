...
degree: 'Thesis submitted for the degree of Doctor of Philosophy'
...
#  sussexthesis::thesis_gitbook: default         
#  sussexthesis::thesis_word: default
#  sussexthesis::thesis_epub: default

# If you are creating a PDF you'll need to write your preliminary content 
# (e.g., abstract, acknowledgements) below. 
...
declaration: |
  Type your declaration here. 

# Specify the location of the bibliography below
bibliography: bib/thesis.bib

# Download your specific csl file and refer to it in the line below, apa is the default.
csl: csl/apa.csl
...
If you'd prefer to not include acknowledgements, for example, simply delete the section entirely, or silence them (add # before each line). 
